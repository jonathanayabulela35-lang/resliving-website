        ...
        >
          ...
          <div className="relative px-8 py-16 sm:px-12 sm:py-20 lg:px-20 lg:py-24 text-center">
            ...
            <p className="mt-4 text-lg text-white/70 max-w-xl mx-auto">
              Join ResLiving and give your residents the smart living experience
              they deserve.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                ...
                className="bg-destructive hover:bg-destructive/90 text-white px-8 h-12 text-base font-semibold shadow-lg"
              >
