...
import {
  ArrowRight, Shield, Wrench, Bell, FileText, Users, Lock,
  Building2, Eye, AlertTriangle, CalendarDays, MessageSquare, BookOpen
} from "lucide-react";
...
const features = [
  {
    ...
    description: "Students pre-register visitors. Security verifies at the gate. Complete audit trail of who enters and exits the building.",
    category: "Security"
  },
  {
    icon: Wrench,
    title: "Maintenance Requests",
    description: "Students report issues directly through the app. Managers track and resolve requests efficiently.",
    category: "Operations"
  },
  {
    icon: Bell,
  ...
  },
  {
    ...
    description: "Centralised access to building details, contact numbers, emergency procedures, and key policies.",
    category: "Information"
  },
  {
    icon: BookOpen,
    title: "House Rules Access",
    description: "Digitised house rules always available in the app. No excuses for not knowing the rules.",
    category: "Information"
  },
  {
    icon: Shield,
    title: "Security Verification",
    description: "Security guards use the app to verify visitors, manage access, and maintain building safety.",
    category: "Security"
  },
  {
    icon: Lock,
  ...
  },
  {
    ...
    description: "Building access is controlled by subscription. If not renewed, access suspends automatically until payment is restored.",
    category: "Management"
  },
];
